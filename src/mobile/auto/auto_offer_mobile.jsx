  ...
  const onSubmit = () => {
    ...
    return (
      ...
      <List title="Place Order" className="date-picker-list" style={{ padding: '4px' }}>
        ...
        <List.Item><InputItem clear value={price} onChange={value => setPrice(value)}>Price</InputItem></List.Item>
        <br/>
        <h3 style={{marginLeft: '15px'}}>Seller Information</h3>
        <List.Item><InputItem clear value={seller} onChange={value => setSeller(value)}>Seller</InputItem></List.Item>
